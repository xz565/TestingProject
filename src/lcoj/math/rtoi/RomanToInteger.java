...
public class RomanToInteger {
  ...
  public int romanToInt(String s) {
	...
	// only rule for this:
	// if next char is great than current, the add next - curt
  	// another thing is the use of a map
	public int romanToInt2(String s) {
		...
		for (int i = 0; i < s.length(); i++) {
			int curtVal = map.get(s.charAt(i));
  ...
  public static void main(String[] args) {
    ...
    System.out.println(rtoi.romanToInt2("XLVIII"));
  }
}
